(function($,window) {
  ...
  window.AppSwitcher.createGroup = function() {
    ...
    var $newGroup = $( '<div class="app-group"><div class="app-group__heading"><h2 class="js-group-title">Untitled</h2></div><div class="app-group__content js-drag-app-group"></div></div>' );
